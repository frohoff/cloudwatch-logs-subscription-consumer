 ...
 */
public class KinesisPipeline implements IKinesisConnectorPipeline<CloudWatchLogsEvent, KinesisEmitter.Record> {

    @Override
    public IEmitter<KinesisEmitter.Record> getEmitter(KinesisConnectorConfiguration configuration) {
    ...
    @Override
    public ITransformerBase<CloudWatchLogsEvent, KinesisEmitter.Record> getTransformer(KinesisConnectorConfiguration configuration) {
